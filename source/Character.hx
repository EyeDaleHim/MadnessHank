	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				antialiasing = FlxG.save.data.antialiasing;
			case 'depredated-hank':
				frames = Paths.getSparrowAtlas('depredated_hank');
				animation.addByPrefix('idle', 'Hank idle', 24, false);
				animation.addByPrefix('singUP', 'Hank Up', 24, false);
				animation.addByPrefix('singDOWN', 'Hank Down', 24, false);
				animation.addByPrefix('singLEFT', 'Hank Left', 24, false);
				animation.addByPrefix('singRIGHT', 'Hank Right', 24, false);

				addOffset('idle');
				addOffset("singUP", 72, 47);
				addOffset("singRIGHT", 34, -33);
				addOffset("singLEFT", 118, -20);
				addOffset("singDOWN", -41, -29);
				...
				antialiasing = FlxG.save.data.antialiasing;
			case 'hank':
				frames = Paths.getSparrowAtlas('hank');
				animation.addByPrefix('idle', 'Hank idle', 24, false);
				animation.addByPrefix('singUP', 'Hank Up', 24, false);
				animation.addByPrefix('singDOWN', 'Hank Down', 24, false);
				animation.addByPrefix('singLEFT', 'Hank Left', 24, false);
				...
				addOffset('idle');
				addOffset("singUP", 13, 122);
				addOffset("singRIGHT", -96, 149);
				addOffset("singLEFT", 92, 38);
				addOffset("singDOWN", -56, -1);
